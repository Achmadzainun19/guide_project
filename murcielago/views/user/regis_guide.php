              ...
              <?php //echo tokenField(); ?>
               <div class="form-horizontal">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" type="text" name="username" id="username" value="" required onkeyup="cekusername()" focus>
           ...
           <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <div class="col-sm-2">
                      <label>Deskripsikan Anda <b style="color:red;">*</b></label>
                    </div>
                    <div class="col-sm-10">
                      <textarea class="form-control" name="deskripsi" rows="4" id="deskripsi"></textarea>
                    </div>
                  </div>

                  <div class="form-group">
                    <div class="col-sm-2">
                      <label id="pekerjaan">Bahasa yang dikuasai <b style="color:red;">*</b></label>
                    </div>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="bahasa" id="bahasa">
                      <small>Pisahkan dengan tanda baca koma ( , )</small>
                    </div>
                  </div>
        ...
        function aksiku(){
            var data = new FormData(document.getElementById('upload_form'));
              if($("#nama_lengkap").val() == ""){
                ...
                pesanGagal('Masukkan Deskripsi Anda');
              }else if($("#bahasa").val() == ""){
                pesanGagal('Masukkan Bahassa yang anda kuasai');
              }else{
                $.ajax({
                type: 'POST',
                url: '<?php echo base_url('register/auth_guide') ?>?',
                data: data,
                contentType: false,
                cache: false,
                processData:false,
