...
$(function() {
  ...
  if(jQuery().summernote) {
    ...
    $("#summernoteinfo").summernote({
       dialogsInBody: true,
      minHeight: 250,
      placeholder: 'Berikan informasi mengenai apa saja yang ada dalam paket wisata ini termasuk include dan exlude, dan juga jangan lupa penjelasan harga.'
    });
    $("#summernotejadwal").summernote({
       dialogsInBody: true,
      minHeight: 250,
      placeholder: 'Contoh jadwal paket wisata bisa di download pada tombol dibawah.'
    });
    $(".summernotejadwalx").summernote({
       dialogsInBody: true,
      minHeight: 250,
      placeholder: 'Contoh jadwal paket wisata bisa di download pada tombol dibawah.'
    });
